...
Vertix::Engine::PerspectiveCamera::PerspectiveCamera(const float aspect,
                                                     const float fov,
...
Vertix::Engine::PerspectiveCamera::PerspectiveCamera() : aspect(4.0 / 3.0) , fov(DegreesToRadians(45)) , nearPlane(0.1f) , farPlane(100) {
    projectionMatrix = Matrix::CreatePerspectiveFieldOfView(fov, aspect, nearPlane, farPlane);
...
void Vertix::Engine::PerspectiveCamera::Move(const Vector3 &offset,
                                             const bool relative,
...
void Vertix::Engine::PerspectiveCamera::Rotate(const Vector3 &angles, const bool allowRoll) {
