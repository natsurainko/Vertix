...
Vertix::DescriptorHandle Vertix::DescriptorHeapSet::CreateRTV(ID3D12Resource *resource,
...
Vertix::DescriptorHandle Vertix::DescriptorHeapSet::CreateDSV(ID3D12Resource *resource,
...
Vertix::DescriptorHandle Vertix::DescriptorHeapSet::CreateUAV(ID3D12Resource *resource,
...
Vertix::DescriptorHandle Vertix::DescriptorHeapSet::CreateSRV(ID3D12Resource *resource,
