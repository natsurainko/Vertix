...
namespace Vertix {
    ...
    template<> struct RenderTextureView<DepthStencil> : detail::RenderTextureViewBase_Cpu {
        ...
        void Reuse(const Microsoft::WRL::ComPtr<ID3D12Device> &d3d12Device, ID3D12Resource* d3d12Resource) const {
    ...
    template<> struct RenderTextureView<RenderTarget> : detail::RenderTextureViewBase_Cpu {
        friend class RenderTextureViewAllocator;
    ...
    template<> struct RenderTextureView<UnorderedAccess> : detail::RenderTextureViewBase_CpuGpu {
        friend class RenderTextureViewAllocator;
        ...
        void Reuse(const Microsoft::WRL::ComPtr<ID3D12Device> &d3d12Device, ID3D12Resource* d3d12Resource, ID3D12Resource* counterResource) {
    ...
    template<> struct RenderTextureView<ShaderResource> : detail::RenderTextureViewBase_CpuGpu {
        friend class RenderTextureViewAllocator;
        void SetGraphicsRootDescriptorTable(ID3D12GraphicsCommandList* cmd, const UINT rootParameterIndex) const { cmd->SetGraphicsRootDescriptorTable(rootParameterIndex, gpuHandle); }
        void SetComputeRootDescriptorTable(ID3D12GraphicsCommandList* cmd, const UINT rootParameterIndex) const { cmd->SetComputeRootDescriptorTable(rootParameterIndex, gpuHandle); }
